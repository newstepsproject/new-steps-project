    ...
    <main className="flex-1">
      ...
      <section className="py-12 md:py-20 bg-gradient-to-b from-brand-50 to-white">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">Get Free Sports Shoes Ready to Play Again</h1>
          <p className="text-base md:text-lg text-gray-700 max-w-2xl mx-auto mb-6 leading-relaxed">
